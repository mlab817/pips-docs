...
export default function PdpChapter() {
    return (
        <Card style={{
            ...
            <Form.Item label='Main PDP Chapter'>
                <TreeSelect treeDefaultExpandAll treeData={[
                    {
                        "value": 1,
            ...
            <Card.Meta
                title={<Divider orientation='left'>23. Main PDP Chapter</Divider>}
                description='Select from the dropdown list the Main PDP Chapter under which the program/project is expected to primarily contribute.'
            />
        </Card>
    )
}