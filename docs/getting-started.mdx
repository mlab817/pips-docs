...
Upon successful registration to the system, the user will receive an email with their login credentials and instructions
on how to login to the System. A sample email is provided below:

![Onboarding email](./email.png)

## Accessing the System

1. To access the PIP System, open the web browser and type https://pips.da.gov.ph in the address bar. You may also copy
the URL below and paste it to your browser.

```
https://pips.da.gov.ph
```
...
3. Upon log-in, the user will be directed to the Dashboard. Shown in the Dashboard are
   information for the user’s reference such as the quick statistics in the PIP System.
...
<Card.Meta title={<Divider orientation='left'>User Interface</Divider>} description='Hover over the elements learn about the different parts of the user interface.' />
</Card>

4. Select the operation to be performed by choosing among the modules in the Sidebar menu.
